...
const TAB_TITLES: Record<string, { title: string; sub: string }> = {
  ...
  drafts: { title: "Prompts", sub: "Support Coordination prompts" },
  rag: { title: "Research", sub: "Data gathered from all sources" },
...
const SEARCH_PLACEHOLDERS: Record<string, string> = {
  ...
  drafts: "Search prompts...",
  rag: "Search research history…",
...
const PILL_SETS: Record<string, string[]> = {
  ...
  drafts:       ["All", "SC Prompts", "Report Templates", "Email Templates", "System Prompts", "Custom"],
  rag:          ["All", "RAG", "Email", "SC Folder", "Local Files", "Manual"],
